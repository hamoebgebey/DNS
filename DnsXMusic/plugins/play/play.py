...
            "تشغيل قناة", # cplay
            "لطيف",      # cute
            "تشغيل قناة فيديو", # cvplay
            "تشغيل بالقوة", # playforce
            "تشغيل فيديو بالقوة", # vplayforce
            "تشغيل قناة بالقوة", # cplayforce
            "تشغيل قناة فيديو بالقوة", # cvplayforce
        ],
        prefixes=["/", "!", "%", ",", "@", "#"],  # بادئات مختلفة
    )
    & filters.group  # يعمل في المجموعات
    & ~BANNED_USERS # يستثني المستخدمين المحظورين
)
@PlayWrapper
...
@app.on_callback_query(filters.regex("DnsPlaylists") & ~BANNED_USERS)
@languageCB
